...
def relevance_checker(state):
    ...
    for doc in documents:
        ...
        # -----------------------------------------
        # 4. Preserve retrieval score
        # -----------------------------------------

        retrieval_score = doc.get("score", 0)

        # Retrieval score is used as a tie-breaker.
        final_score = score + (retrieval_score * 0.5)
    ...
    # -----------------------------------------
    # 5. Select strongest relevant document
    # -----------------------------------------
    ...
    if relevant_docs:
        ...
        print(
            f"Selected Chunk: "
            f"{relevant_docs[0].get('chunk_id')} | "
            f"Page {relevant_docs[0].get('page')}"
        )
